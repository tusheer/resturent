...
const BlogDetails = (props)=> {
  console.log(props)
    return (
        ...
        <section style={{marginTop:'50px'}} className="blog_area single-post-area section-margin">
                <div className="container">
                        <div className="row">
                                <div className="col-lg-8 posts-list">
                                        <div className="single-post">
                                                        <div className="feature-img">
                                                                <img className="img-fluid" src="img/home/offer-img.png" alt=""/>
                                                        </div>
                      ...
                      <div className="navigation-top">
                        <div className="d-sm-flex justify-content-between text-center">
                          <p className="like-info"><span className="align-middle"><i className="ti-heart"></i></span> Lily and 4 people like this</p>
                          <div className="col-sm-4 text-center my-2 my-sm-0">
                            <p className="comment-count"><span className="align-middle"><i className="ti-comment"></i></span> 06 Comments</p>
                          </div>
                          <ul className="social-icons">
                            <li><a href="#"><i className="ti-facebook"></i></a></li>
                            <li><a href="#"><i className="ti-twitter-alt"></i></a></li>
                            <li><a href="#"><i className="ti-dribbble"></i></a></li>
                            <li><a href="#"><i className="ti-wordpress"></i></a></li>
                          </ul>
                        </div>
                        ...
                        <div className="navigation-area">
                            <div className="row">
                                <div className="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                                    ...
                                    <div className="arrow">
                                        <a href="#">
                                            <span className="ti-arrow-left text-white"></span>
                                        </a>
                                    </div>
                                ...
                                <div className="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                                    ...
                                    <div className="arrow">
                                        <a href="#">
                                            <span className="ti-arrow-right text-white"></span>
                                        </a>
                                    </div>
                                    <div className="thumb">
                                        <a href="#">
